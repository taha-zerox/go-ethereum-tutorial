...
var APP_HOSTNAME =
    "See package.json --> scripts --> start: Change 'localhost'!!!";

var GETH_RPCPORT = 9001; // for geth --rpcport GETH_RPCPORT
    ...
    .directive("nTooltips", function () {
        return {
            link: function ($scope, element, attrs) {
                var imgArrow =
                    "data:image/png;base64,";
                var imgArrowCss = {
                    position: "absolute",
                    top: "-10px",
                    left: "5px",
                    ...
                    element
                        ...
                        .hover(
                            function (a) {
                                ...
                                $("body").append(
                                    '<p id="ntooltips"><img id="ntooltipsArrow" />' +
                                        this.t +
                                        "</p>"
                                );
                                $("p#ntooltips #ntooltipsArrow")
                                    .attr("src", imgArrow)
                                    .css(imgArrowCss);
                                $("p#ntooltips")
                                    .css(ntooltipsCss)
